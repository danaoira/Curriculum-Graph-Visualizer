...
c0.edge('Semester 7', 'Semester 8', color='red')
c0.edge('Semester 7', 'Semester 8', arrowhead='dot', arrowtail='dot', dir='both', color='black')
...
c.body.append('{ rank = same; "CPSC 120", "MATH 270A" }')
